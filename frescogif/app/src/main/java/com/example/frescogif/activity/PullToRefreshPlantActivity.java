 ...
 */
public class PullToRefreshPlantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pull_to_refresh_plant);
    ...
    class SampleAdapter extends ArrayAdapter<Map<String, Integer>> {
        ...
        public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.list_item_plant, parent, false);
