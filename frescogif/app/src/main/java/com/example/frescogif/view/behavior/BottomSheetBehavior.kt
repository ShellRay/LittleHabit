...
import com.kienht.bottomsheetbehavior.readBoolean
import com.kienht.bottomsheetbehavior.writeBoolean
...
class BottomSheetBehavior<V : View> : CoordinatorLayout.Behavior<V> {
    ...
    companion object {
        ...
        const val STATE_DRAGGING = 1 //被拖拽状态
        /** The bottom sheet is settling. */
        const val STATE_SETTLING = 2 //拖拽松开之后到达终点位置
        /** The bottom sheet is expanded. */
        const val STATE_EXPANDED = 3 //完全展开的状态
        /** The bottom sheet is collapsed. 折叠关闭状态*/
        const val STATE_COLLAPSED = 4  //折叠关闭状态
        /** The bottom sheet is hidden.  隐藏状态*/
        const val STATE_HIDDEN = 5 //隐藏状态
