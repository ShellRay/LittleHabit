...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0x99FFFFFF,
			0x99FFFFFF, 0x99FFFFFF };//这些才是背景颜色
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.wheel_checked;//选中的一条颜色
	private int wheelForeground = R.drawable.wheel_checked;
