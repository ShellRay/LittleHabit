...
public class BarrageViewSimple extends RelativeLayout {
    ...
    public BarrageViewSimple(Context context) {
        this(context, null);
    }

    public BarrageViewSimple(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BarrageViewSimple(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.BarrageViewSimple, 0, 0);
        try {
            textLeftPadding = typedArray.getInt(R.styleable.BarrageViewSimple_text_left_padding, DEFAULT_PADDING);
            textRightPadding = typedArray.getInt(R.styleable.BarrageViewSimple_text_right_padding, DEFAULT_PADDING);
            textTopPadding = typedArray.getInt(R.styleable.BarrageViewSimple_text_top_padding, DEFAULT_PADDING);
            textBottomPadding = typedArray.getInt(R.styleable.BarrageViewSimple_text_bottom_padding, DEFAULT_PADDING);
            maxBarrageSize = typedArray.getInt(R.styleable.BarrageViewSimple_size, DEFAULT_BARRAGESIZE);
            maxTextSize = typedArray.getInt(R.styleable.BarrageViewSimple_max_text_size, DEFAULT_MAXTEXTSIZE);
            minTextSize = typedArray.getInt(R.styleable.BarrageViewSimple_min_text_size, DEFAULT_MINTEXTSIZE);
            lineHeight = typedArray.getDimensionPixelSize(R.styleable.BarrageViewSimple_line_height, BarrageTools.dp2px(context, DEFAULT_LINEHEIGHT));
    ...
    private void showBarrage(final Barrage tb) {
        ...
        Drawable drawable = textView.getContext().getResources().getDrawable(R.drawable.li_circle_color);
