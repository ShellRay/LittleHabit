...
public class BarrageView extends RelativeLayout {
    ...
    private void init(Context context){
        mScreenWidth = MediaUtils.getScreenWH(context).widthPixels;
    ...
    private void createBarrageItemView(Context context,String text,int textSize,int textColor){
        ...
        textView.setBackgroundResource(R.drawable.li_circle_color);
        if (textColor != 0){
        ...
        lp.topMargin = row * (height + MediaUtils.dip2px(context,10));
//        lastRow = row;
        textView.setLayoutParams(lp);
        textView.setPadding(MediaUtils.dip2px(context,15), MediaUtils.dip2px(context,2), MediaUtils.dip2px(context,15), MediaUtils.dip2px(context,2));
