...
import com.example.frescogif.view.LoadingAnima.AVLoadingIndicatorView;

/**
 * Created by GG on 2018/2/11.
 */
            ...
            public void onBindViewHolder(IndicatorHolder holder, final int position) {
                ...
                holder.itemLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        /*Intent intent=new Intent(LoadingAnimActivity.this,IndicatorActivity.class);
