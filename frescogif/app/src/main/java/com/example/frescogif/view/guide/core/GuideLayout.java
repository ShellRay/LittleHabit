...
import com.example.frescogif.view.guide.listener.AnimationListenerAdapter;
...
import com.example.frescogif.view.guide.model.HighlightOptions;
            ...
            if (viewIds != null && viewIds.length > 0) {
                for (int viewId : viewIds) {
                    ...
                    if (click != null) {
                        ...
                        Log.w("shell", "can't find the view by id : " + viewId + " which used to remove guide page");
                    }
                }
            }
