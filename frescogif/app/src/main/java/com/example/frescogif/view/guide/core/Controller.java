...
import com.example.frescogif.view.guide.lifecycle.ListenerFragment;
import com.example.frescogif.view.guide.lifecycle.V4ListenerFragment;
...
public class Controller {
    ...
    public Controller(Builder builder) {
        ...
        sp = activity.getSharedPreferences("shell", Activity.MODE_PRIVATE);
