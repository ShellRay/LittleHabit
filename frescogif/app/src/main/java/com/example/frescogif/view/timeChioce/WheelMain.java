package com.example.frescogif.view.timeChioce;
...
//		wv_mins = (WheelTimeView) view.findViewById(R.id.mins);
//		if (hasSelectTime) {
...
//			wv_mins.setVisibility(View.VISIBLE);
		...
		// 添加"年"监听
		OnWheelTimeChangedListener wheelListener_year = new OnWheelTimeChangedListener() {
		...
		// 添加"月"监听
		OnWheelTimeChangedListener wheelListener_month = new OnWheelTimeChangedListener() {
			public void onChanged(WheelTimeView wheel, int oldValue, int newValue) {
